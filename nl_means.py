...
from utils import create_gaussian, add_noise_salt_and_pepper_noise, add_noise_gaussian
...
def nl_means(gt_image, patch_size, search_size, h, sigma, a, noise_mode="gaussian"):
    ...
    if noise_mode == "gaussian":
        noisy_image = add_noise_gaussian(gt_image)
    elif noise_mode == 's&p':
        noisy_image = add_noise_salt_and_pepper_noise(gt_image)
